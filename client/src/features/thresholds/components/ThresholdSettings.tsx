...
const ThresholdSettings = () => {
  ...
  const { data: thresholdList, isLoading } = useGetThresholdQuery(
    { id: userId! },
    { skip: !userId },
  );
  ...
  const updateThreshold = () => {
    handleOpenDrawer('Edit your threshold values', 'UpdateThresholdForm', {
      thresholdData: thresholdList,
    });
  };
                    ...
                    <div
                      {...{
                        className: header.column.getCanSort()
                          ? 'cursor-pointer hover:text-neutral'
                          : '',
