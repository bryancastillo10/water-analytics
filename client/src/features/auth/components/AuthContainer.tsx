  ...
  return (
    <main className="bg-primary/80 bg-[url(@/assets/screenwrapper.png)]  w-full min-h-screen xl:h-screen relative overflow-x-hidden">
      <section className="flex flex-col justify-center items-center h-screen w-fit m-auto">
        <div
          className={`${isPasswordResetScreen ? 'md:w-[80%] lg:w-[75%] xl:w-[50%]' : 'md:w-[95%] lg:w-full xl:w-[550px]'} w-[90%]  mx-auto 
        ...
        >
          ...
          <p className={`text-darkGray leading-tight text-sm md:text-base ${captionAlignment}`}>
            {caption}
          </p>
      ...
      {isOpenModal && handleCloseModal && (
        <RegisterAccountModal isOpenModal={isOpenModal} handleCloseModal={handleCloseModal} />
      )}
    </main>
  );
};
