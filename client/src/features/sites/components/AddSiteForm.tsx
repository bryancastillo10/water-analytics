    ...
    <form onSubmit={handleSubmit}>
      {!isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-x-4">
          ...
          />
          <UploadImageInput label="Site Photo" icon={Image} onImageSelect={handleImageSelect} />
          <FormTextarea
            id="description"
            label="Description"
            icon={Notepad}
            ...
            onChange={onChangeInput}
            validationMessage={
              addSiteData.description.length > 200
                ? 'Too long!'
                : 'Write a short description about the site'
            }
          />
