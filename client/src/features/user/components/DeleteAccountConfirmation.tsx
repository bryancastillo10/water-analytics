...
const DeleteAccountConfirmation = () => {
  ...
  const { confirmUsername, isLoading, onChangeUsernameInput, handleSubmit } = useDeleteUser(
    userId!,
  );
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <p className="flex text-rose-600 items-center gap-2 text-sm my-2">
        ...
        Deleting your account means that all of your data related to this app will be deleted as
        well
      </p>
