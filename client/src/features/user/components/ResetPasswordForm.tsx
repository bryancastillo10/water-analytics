  ...
  if (step === STEP.VALIDATION) {
    bodyContent = (
      ...
      >
        ...
        <div className="my-8">
          <Button action={stepBackward} variant="outline">
            <ArrowLeft />
          </Button>
  ...
  return (
    <section className="flex flex-col justify-center w-fit">
      <p className="text-balance leading-tight">
        Reset your password by providing your user e-mail. A 5-digit authentication code would be
        sent to your e-mail upon request.
      </p>
      {bodyContent}
    </section>
  );
