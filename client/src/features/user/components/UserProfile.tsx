  ...
  return (
    <section className="px-6 py-4">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Profile Picture  */}
        <div className="relative grid place-items-center md:place-items-start group">
          <img
        ...
        {/* User Details */}
        <div
          className="col-span-2 flex group flex-col justify-between border border-transparent border-dashed 
        ...
        >
          ...
          <p className={`${theme ? 'text-secondary' : 'text-primary'} text-base mt-1`}>
